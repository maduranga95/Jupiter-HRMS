...
@keyframes fadeIn {
	...
	<body>
			...
			<section id="two">
				<div class="inner">
					<article>
						<div class="content">
							<header>
								<h3>REPORTS OF DEPARTMENTS</h3>
							</header>
							<div class="image fit">
								<img src="images/pic01.jpg" alt="" />
							</div>
							<p>This includes Employee Details Report, Budget Report and Total Leave Report. Every report above is according to each department. </p>
						</div>
						<ul class="actions">
							<li><a id="myBtn" class="button alt">CHECK REPORTS OF DEPARTMENTS</a></li>
						</ul>
					</article>
					...
					<article class="alt">
						...
						<ul class="actions">
							<li><a href="#" class="button alt">CHECK EMPLOYEE REPORT</a></li>
						</ul>
					</article>
				</div>
			</section>
		...
		<section id="three">
			<div class="inner">
				<header>
					<h2>VISIT OUR BRANCHES AROUND THE GLOBE</h2>
				</header>
			</div>
				...
				<div class="inner">
					...
					<article>
						<div class="content">
							...
							<p>No. 1 Road TS-23,<br> Dong Nguyen Com. Tien Son Indus. Zone,<br> Tu Son Dis.</p>
							<ul class="actions">
								<li><a href="#" class="button alt">Learn More</a></li>
							</ul>
						</div>
					...
					<div class="content">
							...
							<p>Jl, <br> Engku Putri,<br> Blok A : No. 7, <br> Kelurahan Belian.</p>
							<ul class="actions">
								<li><a href="#" class="button alt">Learn More</a></li>
							</ul>
						</div>
